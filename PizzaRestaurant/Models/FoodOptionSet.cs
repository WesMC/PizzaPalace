...
{
    public class FoodOptionSet
    {
        [Key, DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Guid FoodOptionSetId { get; set; }

        [Required(ErrorMessage = "FoodOptionSet Name is Required."), StringLength(150)]
        public string Name { get; set; }

        //[Required(ErrorMessage="MenuItemId is Required for FoodOptionSet."), ForeignKey("MenuItem")]
        public Guid MenuItemId { get; set; }

        [ForeignKey("FoodOptionSetId")]
        public IList<FoodOption> FoodOption { get; set; }

        [DataType(DataType.Currency), Required(ErrorMessage = "FoodOptionSet Has NULL Charge, Please Set Food Item Charge.")]
